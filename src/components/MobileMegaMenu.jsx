...
import LoginModal from "./LoginModal"; // path correct ah irukanu check pannu
        ...
        {currentPage === "main" && (
          <>
            ...
            <div className="mobile-fixed-footer bg-white shadow">
              ...
              <button
                className="btn btn-outline-primary w-100 py-3 fw-semibold rounded-3 mt-2"
                onClick={() => setShowLoginModal(true)}
              >
                Log In
              </button>
          ...
          <div className="submenu-page">
            ...
            <h4 className="submenu fw-bold px-2 mt-2">
              ...
              {currentPage === "certificates" &&
                "Earn a Professional Certificates"}
            </h4>
