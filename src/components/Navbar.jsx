...
<div className="ms-auto d-flex d-xl-none align-items-center gap-3">
  <FiSearch size={18} color="#333" style={{ cursor: "pointer" }} />
</div>
        ...
        <div className="collapse navbar-collapse d-none d-xl-flex">
          ...
          {/* SEARCH BAR */}
          <div
            className="ms-4 d-flex align-items-center border rounded-pill px-3"
            style={{ width: "460px", height: "42px", borderColor: "#CDD3DF" }}
          >
            <input
              type="text"
          ...
          <div className="ms-auto d-flex align-items-center gap-3">
            <span className="login-btn text-primary" style={{ cursor: "pointer" }}>
              Log In
            </span>

            <button
              className="btn border-primary text-primary fw-semibold"
              style={{
                borderWidth: "2px",
                borderRadius: "10px",
                padding: "8px 18px",
              ...
              onMouseEnter={(e) => (e.target.style.background = "#E7F1FF")}
...
>
  <div className="offcanvas-header">
    <h6 className="offcanvas-title"> <a className="navbar-brand ms-3 ms-xl-0" href="#">
          <svg
            viewBox="0 0 1155 164"
            xmlns="http://www.w3.org/2000/svg"
            className="logo-svg"
